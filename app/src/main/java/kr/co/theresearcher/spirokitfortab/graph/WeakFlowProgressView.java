...
public class WeakFlowProgressView extends View {
    ...
    public WeakFlowProgressView(Context context) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 1; i < number; i++) {
            ...
            if (visibleLabels[i]) {
                ...
                canvas.drawText(Float.toString(((interval * (float)i)) / 1000) + " l/s", (padding * i) - 10f, canvasHeight - 3f, labelPaint);
            }
